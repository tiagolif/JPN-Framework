...
if (htmlFiles.length !== 14) {
  errors.push(`esperados 14 HTMLs comerciais (landing + seletor + comparação + como funciona + casos de uso + primeiros passos + demonstração + FAQ + 6 produtos), encontrados ${htmlFiles.length}`);
}
