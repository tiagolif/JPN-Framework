...
console.log('JPN handoff migration OK: baseline 0.1 preservada, conteúdo e imutabilidade protegidos, migração determinística 0.1→0.2 validada e timestamps formal ou semanticamente inseguros bloqueados.');
