...
console.log(`Product portfolio check OK: ${portfolioProducts.length} produtos canônicos, rotas, casos de uso, diagnóstico, matriz comparativa, one-pagers e FAQ/objeções validados.`);
